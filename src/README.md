  ...
  - bgImageStyle:
    ...
    features:
      ...
      - title: Clash订阅转换
        ...
        details: 通过复制订阅链接或上传配置文件的方式进行订阅导入
        link: https://clashnode.org/subconverter
...
copyright: false
footer: 使用 <a href="https://theme-hope.vuejs.press/zh/" target="_blank">VuePress Theme Hope</a> 主题 | MIT 协议, 版权所有 © 2019-present bincooo
---
