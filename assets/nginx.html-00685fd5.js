import{_ as n,Z as s,$ as a,a4 as e}from"./framework-8386e87f.js";const i={},t=e(`<h3 id="location-一些基础匹配规则" tabindex="-1"><a class="header-anchor" href="#location-一些基础匹配规则" aria-hidden="true">#</a> location 一些基础匹配规则</h3><div class="language-nginx line-numbers-mode" data-ext="nginx"><pre class="language-nginx"><code><span class="token comment"># 精确匹配 / : 主机名后面不能带任何字符串</span>
