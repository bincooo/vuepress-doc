import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,e as s,o as i}from"./app-DitLSZeN.js";const l={};function d(r,e){return i(),a("div",null,e[0]||(e[0]=[s(`<h2 id="k8s指令" tabindex="-1"><a class="header-anchor" href="#k8s指令"><span>K8S指令</span></a></h2><h4 id="指令汇总" tabindex="-1"><a class="header-anchor" href="#指令汇总"><span>指令汇总</span></a></h4><div class="language-tex line-numbers-mode" data-ext="tex" data-title="tex"><pre class="language-tex"><code>kubectl 控制 Kubernetes 集群管理器。
