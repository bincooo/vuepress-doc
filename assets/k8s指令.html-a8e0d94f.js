import{_ as e,Z as n,$ as a,a4 as s}from"./framework-e0d053a9.js";const i={},d=s(`<h2 id="k8s指令" tabindex="-1"><a class="header-anchor" href="#k8s指令" aria-hidden="true">#</a> K8S指令</h2><h4 id="指令汇总" tabindex="-1"><a class="header-anchor" href="#指令汇总" aria-hidden="true">#</a> 指令汇总</h4><div class="language-tex line-numbers-mode" data-ext="tex"><pre class="language-tex"><code>kubectl 控制 Kubernetes 集群管理器。
