import{_ as t}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as i,a as s,e as l,d as a,b as o,r as p,o as d}from"./app-B8je2evO.js";const c={},r={href:"https://www.mongodb.com/docs/manual/installation/",target:"_blank",rel:"noopener noreferrer"};function u(m,n){const e=p("ExternalLinkIcon");return d(),i("div",null,[n[2]||(n[2]=s("h3",{id:"下载并安装",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#下载并安装"},[s("span",null,"下载并安装")])],-1)),s("p",null,[n[1]||(n[1]=a("可参照官网步骤 ")),s("a",r,[n[0]||(n[0]=a("查看")),o(e)])]),n[3]||(n[3]=l(`<ol><li><p>添加yum源</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>mongodb-org-8.0<span class="token punctuation">]</span>
