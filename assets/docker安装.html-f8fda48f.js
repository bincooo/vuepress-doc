import{_ as a,X as i,Y as l,Z as n,$ as s,a0 as d,a2 as c,E as o}from"./framework-c34206ea.js";const t={},r=n("h3",{id:"下载并安装",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#下载并安装","aria-hidden":"true"},"#"),s(" 下载并安装")],-1),p={href:"https://docs.docker.com/engine/install/centos",target:"_blank",rel:"noopener noreferrer"},u=c(`<ol><li><p>如之前已安装过先删除</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">sudo</span> yum remove <span class="token function">docker</span> <span class="token punctuation">\\</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,11);function v(m,b){const e=o("ExternalLinkIcon");return i(),l("div",null,[r,n("p",null,[s("可参照官网步骤 "),n("a",p,[s("查看"),d(e)])]),u])}const h=a(t,[["render",v],["__file","docker安装.html.vue"]]);export{h as default};
